"""
Implementation with all blocking strategies: prefix, metaphone, soundex, and ngram
"""
import pandas as pd
import itertools
import uuid
...
def build_duplicate_df(df: pd.DataFrame, col_map: Dict[str, str], name_threshold: int = 70, overall_threshold: int = 70) -> Tuple[int, int]:
    """
    Deduplication with all blocking strategies: prefix, metaphone, soundex, and ngram
